...
object RasterTimeseriesArea {
   ...
   * @return
   */
  def getGdcRasterTimeseriesArea(sc: SparkContext, cubeId: String, productName: String, bbox: String, startTime: String, endTime: String, aggregate: String, measurementsStr: String, outputDir: String): String = {
  ...
  def main(args: Array[String]): Unit = {
    ...
    getGdcRasterTimeseriesArea(sc, cubeId, rasterProductName, extent, startTime, endTime, aggregate, measurements, outputDir)
