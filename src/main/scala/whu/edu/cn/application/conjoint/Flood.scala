package whu.edu.cn.application.conjoint
...
import whu.edu.cn.application.conjoint.Overlap.overlappedGeoObjects
import whu.edu.cn.core.cube.raster.RasterRDD
import whu.edu.cn.core.cube.vector.{FeatureRDD, GeoObject}
import whu.edu.cn.core.entity.{QueryParams, RasterTileLayerMetadata, SpaceTimeBandKey}
import whu.edu.cn.core.io.Output._
import whu.edu.cn.core.raster.query.{DistributedQueryRasterTiles, QueryRasterTiles}
import whu.edu.cn.core.cube.vector.GeoObjectRDD
import whu.edu.cn.core.vector.query.QueryVectorObjects
...
object Flood{
  ...
  def impactedFeatures(rasterRdd: RasterRDD,
    ...
    val changedRdd:TileLayerRDD[SpatialKey] = whu.edu.cn.application.timeseries.WaterChangeDetection.waterChangeDetectionUsingNDWIProduct(rasterRdd)
  ...
  def impactedFeatures(implicit sc:SparkContext,
    ...
    //calculate flooded regions using pre- and post-disaster ndwi tiles
    val changedRdd:TileLayerRDD[SpatialKey] = whu.edu.cn.application.timeseries.WaterChangeDetection.waterChangeDetectionUsingNDWIProduct(sc, tileLayerArrayWithMeta)
  ...
  def impactedFeaturesService1(implicit sc:SparkContext,
    ...
    //calculate flooded regions using pre- and post-disaster ndwi tiles
    val changedRdd:TileLayerRDD[SpatialKey] = whu.edu.cn.application.timeseries.WaterChangeDetection.waterChangeDetectionUsingNDWIProduct(tileLayerRddWithMeta)
