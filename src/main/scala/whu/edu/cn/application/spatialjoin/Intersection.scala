package whu.edu.cn.application.spatialjoin
...
import whu.edu.cn.core.cube.vector.CompuIntensityPartitioner
import whu.edu.cn.core.entity.QueryParams
import whu.edu.cn.core.vector.grid.GridConf
import whu.edu.cn.core.cube.vector.GeoObject
import whu.edu.cn.core.vector.query.DistributedQueryVectorObjects._
import whu.edu.cn.util.HbaseUtil.getVectorMeta
import whu.edu.cn.util.{PostgresqlService, PostgresqlUtil}
