...
object GcConstant {
  ...
  final val limitByteSize: Long = 209715200 // 200MB
  final val limitBytesSizeWorkflow: Long = 314572800  // 300MB
//  final val limitBytesSizeWorkflow: Long = 1614572800  // 非常大
  //  final val callBackRoot = "http://localhost:8087/geocube/callback/"
  final val callBackRoot = "http://125.220.153.26:8087/geocube/callback/"
