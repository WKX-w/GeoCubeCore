package whu.edu.cn.core.vector.query
...
import whu.edu.cn.core.entity.GcProduct.getProductByKey
import whu.edu.cn.core.entity.{QueryParams, VectorGridLayerMetadata}
import whu.edu.cn.core.vector.grid.GridConf
import whu.edu.cn.core.vector.grid.GridTransformer.getGeomGridInfo
import whu.edu.cn.util.HbaseUtil.getVectorMeta
